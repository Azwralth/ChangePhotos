...
final class TextEffectViewController: UIViewController, UITextViewDelegate {
    ...
    private func setupUI() {
        ...
        settingsButton.titleLabel?.font = UIFont.systemFont(ofSize: 17)
        ...
        NSLayoutConstraint.activate([
            ...
            settingsButton.trailingAnchor.constraint(equalTo: saveButton.leadingAnchor, constant: -20),
